...
const filterFields = (object, ...allowedFields) => {
  const filteredObj = {}
  Object.keys(object).forEach(el => {
    if (allowedFields.includes(el))
      filteredObj[el] = object[el]
  })
  return filteredObj
}
exports.updateUserMiddleware = (req, res, next) => {
  if (req.body.password || req.body.passwordConfirm) {
    return next(new AppError('This route is not for password updates. Please use /updatePassword for password updation', 400))
  }
  next()
}
