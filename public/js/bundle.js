      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "GET",
              url: 'http://127.0.0.1:5050/api/v1/users/logout'
            });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(data);
            url = type === 'data' ? "http://127.0.0.1:5050/api/v1/users/updateMe" : "http://127.0.0.1:5050/api/v1/users/updatePassword";
            _context.prev = 2;
            _context.next = 5;
            return (0, _axios.default)({
              method: "PATCH",
...
var stripe = Stripe('pk_test_51Kf7XiSEjMiV0hYR3nWzlu4TqaIlILBe2y7KwqerjS24U97Fn4NN2RtPLvJ4I6IYyQ3yUQ6zmCntAhtoahCyX5J400tmJ235Z7');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:5050/api/v1/bookings/checkout-session/".concat(tourId));

          case 3:
            session = _context.sent;
            console.log(session); // 2) Create checkout form + sharge credit card
...
if (passwordChangeForm) {
  passwordChangeForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var oldPassword, password, passwordConfirm, passwordChangeBtn;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              passwordChangeBtn = document.querySelector('.password-change-btn');
              passwordChangeBtn.textContent = "Updating...";
              _context2.next = 8;
            ...
            case 8:
              ...
              passwordChangeBtn.textContent = "Save Password";
